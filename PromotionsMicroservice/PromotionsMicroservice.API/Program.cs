...
using PromotionsMicroservice.Application.Services;
...
// 1. Add DbContext
builder.Services.AddDbContext<PromotionsMicroserviceDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("PromotionsMicroserviceDb")));
